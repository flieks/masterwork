...
# API Contract v1.43 — is my installed skill still what I installed, and is upstream ahead of it?

Additive on top of v1.42. A skill installed from the catalog can drift two ways:

...
class Project(Base):
    ...
    asset_ids: Mapped[list[str]] = mapped_column(JSONB, default=list)
    # Last generated summary of all applied asset changes (markdown).
    change_summary: Mapped[str | None] = mapped_column(Text, nullable=True)
    change_summary_at: Mapped[datetime | None] = mapped_column(
    ...
    trigger_guide_at: Mapped[datetime | None] = mapped_column(
        DateTime(timezone=True), nullable=True
    )
    ...
    generality_report_at: Mapped[datetime | None] = mapped_column(
        DateTime(timezone=True), nullable=True
    )
